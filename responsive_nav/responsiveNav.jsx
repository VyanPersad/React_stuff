    ...
    <>
        <NavStyle className={`navbar bg-primary text-light 
            ...
            <div className="navbar-logo">
                <a href='#' className="navbar-brand">Norbert</a>
            ...
            <div className="navbar-collapse">
                {showElement.navbarNav ? 
                    (<ul class={`navbar-items list-unstyled ${showElement.navOpened && "showNavbar"}`}>
        ...
        <h1 className='title text-center text-priomary'>{
